# 🗺️ VectorToMap (v0.3.2)
**Automated High-Performance Atlas Generation for QGIS**

VectorToMap is a specialized QGIS plugin designed for high-precision cartography. Version 0.3.2 introduces adaptive layout management, featuring side-by-side attribute positioning and smart column balancing to optimize page space.

---

## 🚀 Key Features

* **Adaptive Side-by-Side Layout (v0.3.2)**: New 1/3-width form positioning that places HTML attributes alongside individual labels, maximizing space in both Portrait and Landscape.
* **Smart Column Grouping (v0.3.2)**: Dynamic attribute distribution for "No Grouping" mode:
